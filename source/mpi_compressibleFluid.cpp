...
namespace Fluid
{
  ...
  template <int dim>
  void ParallelCompressibleFluid<dim>::assemble(const bool initial_step,
  ...
  template <int dim>
  void ParallelCompressibleFluid<dim>::assemble_system(const bool initial_step)
  {
    assemble(initial_step, true);
  }

  template <int dim>
  void ParallelCompressibleFluid<dim>::assemble_rhs(const bool initial_step)
  {
  ...
  ParallelCompressibleFluid<dim>::solve(const bool initial_step)
  {
